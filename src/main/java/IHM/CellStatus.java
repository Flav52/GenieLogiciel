...
public class CellStatus extends javax.swing.JPanel implements Simulable {
    ...
    public void updateData() {
        Lot l = cell.getLot();
        grainType.setText(l.type);
        grainMeanTemperature.setText(Double.toString(l.temp) + "°C");
        grainHumidity.setText(Double.toString(l.humi) + "%");
        cellCurrentVolumeBar.setValue((int) (cell.getVolume() / cell.volumeMax * 100));
        fanSpeed.setValue(cell.vent.getPuissance());
        cellNumber.setText("Cellule numéro " + cell.id);
        cellVolume.setText(cell.volumeMax + "m^3");
        isFanOn = (cell.vent.getPuissance() > 0);
        autoResizeFan();
        updateFan();
        this.repaint();
    }
